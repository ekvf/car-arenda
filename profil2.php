...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        if (!empty($new_password)) {
            ...
            $stmt->bind_param("ssssi", $Full_Name, $Address, $Phone_Number, $Discount_code, $Client_ID);
        }
...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
     <link href="jquery.fias.min.css" rel="stylesheet">
        <link href="styles.css" rel="stylesheet">

        <script src="https://code.jquery.com/jquery-3.6.0.min.js" type="text/javascript"></script>
        <script src="jquery.fias.js" type="text/javascript"></script>
...
<body>
    ...
    <section class="container mt-4">
        ...
        <form method="POST" class="needs-validation" novalidate>
            ...
            <div class="field">
                <input name="address" type="text" value="<?= $Address ?>" placeholder="Адрес">
            </div>
            <div class="field">
